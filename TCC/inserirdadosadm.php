...
$con = mysql_connect("localhost", "root", "thaand17012015");
	...
	$query = mysql_query("INSERT INTO cadastrousuario(nomecompleto, senha, email, nivel, ativo, cadastro) VALUES ('$nomecompleto', '$senha', '$email', '$nivel', '$ativo', now())") or die("O email desse funcionarios já encontra-se cadastrado");
