...
if($status=='Novo'){	
	$query = mysql_query('SELECT * FROM reclamacao where estatus=\'Novo\'');
...
if($status=='Pendente'){	
	$query = mysql_query('SELECT * FROM reclamacao where estatus=\'Pendente\'');
	while($esc = mysql_fetch_assoc($query)){
	echo '<tr>';
    echo '<td>' . $esc['id'] . '</td>';
	echo '<td>' . $esc['departamento'] . '</td>';
...
if($status=='Concluido'){	
	$query = mysql_query('SELECT * FROM reclamacao where estatus=\'Concluido\'');
	while($esc = mysql_fetch_assoc($query)){
	echo '<tr>';
    echo '<td>' . $esc['id'] . '</td>';
	echo '<td>' . $esc['departamento'] . '</td>';
